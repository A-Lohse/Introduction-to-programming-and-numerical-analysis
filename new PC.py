...
def PCplot(NatUnEm,Ex_inflation,alpha=1):
      """This function plots the first two values given to it, as Unemployment and Inflation. It plots it by assuming that the other value is 0.2 (as calculated in philipsC function)""""
